    ...
    $( "#contact-form" ).validate({
        ...
        messages: {
            name: {
                ...
                minlength: "Tu nombre debe tener {0} letras."
            },
            email: {
            ...
            message: {
                ...
                minlength: "Tu mensaje debe tener más de {0} letras.",
                maxlength: "Tu mensaje debe tener al menos {0} letras."
            }
        }
    });
    ...
    $( "#contact-form" ).on( "submit", function(event) {
        if ( event.isDefaultPrevented() ) {
            ...
            var errorContent =  '<img src="images/files/form-message/error.png">' +
                                '<h5 style="color:#C75C5C;">Algo salió Mal!</h5>' +
                                '<p>ingresa un mail válido.</p>';
...
function contactFormValidation() {
    $( "#contact-form2" ).validate({
        ...
        messages: {
            ...
            subject2: {
                ...
                minlength: "debe tener {0} letras."
            },
            message2: {
                required: "Escribe tu mensaje.",
                minlength: "El mensaje debe tener {0} letras.",
                maxlength: "El mensaje debe tener al menos {0} letras."
            }
        }
    });
    ...
    $( "#contact-form2" ).on( "submit", function(event) {
        if ( event.isDefaultPrevented() ) {
            formError2();
            var errorContent =  '<img src="images/files/form-message/error.png">' +
                                '<h5 style="color:#C75C5C;">Algo anda mal!</h5>' +
                                '<p>Ingresa un mail válido y un nombre con más de 4 letras.</p>';
